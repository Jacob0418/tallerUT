    ...
    <div>
      <div className="shadow-md w-full top-0 left-0 sticky">
        <div className="md:flex items-center justify-between bg-red-500 py-4 md:px-10 px-7">
          ...
          <ul
            className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-red-500 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-200 ease-in ${
          ...
          >
            ...
            {/* Botón de Log Out que ejecuta la función logout */}
            <li className="md:ml-8 text-xl md:my-0 my-7">
              <ButtonNav onClick={logout } className="text-white hover:bg-white hover:text-red-500 duration-200 rounded-[5px_5px_5px_5px] hover:p-1">Log Out</ButtonNav>
            </li>
          </ul>
        </div>
      </div>
