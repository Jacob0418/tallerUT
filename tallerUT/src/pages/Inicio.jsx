    ...
    return (
        <>
            <div className="container-content mt-4">
                <h1 className="text-center text-3xl">Bienvenidos</h1>
                <h2 className="text-center text-3xl">Taller UT</h2>
                <h4 className="text-center text-3xl">"Tu motor merece el mejor trato, confía en nosotros, tu taller mecánico de confianza"</h4>
