    ...
    return (
        <>
            <div className="flex justify-center items-center mt-20 md:mt-20">
                <form className="flex items-center flex-col shadow-xl border-red-500 border-2 border-solid w-[360px] h-auto text-center rounded-[10px_10px_10px_10px] p-5">
                    ...
                    <span className=" relative w-full max-w-[300px]">
                        ...
                        <IoEyeOffOutline onClick={SeePassword} className="absolute right-1 top-1/2 transform -translate-y-1/2 bg-none border-none cursor-pointer p-0">
                            {show === 'password' ? <IoEyeOffOutline /> : <IoEyeOutline />}
                        </IoEyeOffOutline>
                    </span> 
                    <button className="border-2 border-red-500 bg-red-500 rounded-[5px_5px_5px_5px] p-2 font-medium mb-7 mt-7 text-white">Iniciar Sesión</button>
                </form>
            </div>
        </>
    )
